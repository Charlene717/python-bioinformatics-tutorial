/* Python BioInfo Quiz · i18n
 * 與 ../i18n.js 同邏輯：
 * - localStorage key 'pybio_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🐍 Python 生資互動考題", en:"🐍 Python BioInfo Interactive Quiz" },
    ...
    rangeAll:        { zh:"全部 18 個章節", en:"All 18 chapters" },
    ...
    quizAllChapters: { zh:"Python 生資互動考題（全部章節）", en:"Python BioInfo Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"Python 生資互動考題", en:"Python BioInfo Interactive Quiz" },
